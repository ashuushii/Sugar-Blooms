...
import { Mail, Instagram, MapPin, Clock, Heart, Sparkles, MessageCircle } from "lucide-react"
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-pink-600 font-serif">let's get sweet</h1>
            <MessageCircle className="w-8 h-8 text-pink-400 animate-pulse" />
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            ...
            <span className="text-pink-500 text-sm font-medium">orders require 24-48 hours notice</span>
            <Heart className="w-4 h-4 text-pink-400 fill-pink-400" />
          </div>
        </div>
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-3 border-pink-200 rounded-3xl shadow-2xl overflow-hidden">
            <CardContent className="p-0">
              <div className="bg-gradient-to-r from-pink-400 to-rose-400 p-8 text-white text-center">
                ...
                <p className="text-pink-100">we're here to make your day sweeter</p>
              </div>
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="flex items-center space-x-4 p-4 bg-pink-50 rounded-2xl border border-pink-200">
                  ...
                  <div>
                    ...
                    <p className="text-pink-700">24-48 hours advance notice required</p>
                  </div>
                </div>

                <div className="pt-4">
                  <h3 className="text-xl font-bold text-pink-600 mb-4 font-serif text-center">follow our socials</h3>
                  <div className="flex justify-center space-x-4">
                    <Button size="lg" className="bg-gradient-to-r from-pink-400 to-rose-400 hover:from-pink-500 hover:to-rose-500 rounded-full shadow-lg flex items-center gap-2" asChild>
                    ...
                    <Button size="lg" className="bg-gradient-to-r from-pink-400 to-rose-400 hover:from-pink-500 hover:to-rose-500 rounded-full shadow-lg flex items-center gap-2" asChild>
                      <a href="https://tiktok.com/@sugarbloomsco" target="_blank" rel="noopener noreferrer">
                    ...
                    <Button size="lg" className="bg-gradient-to-r from-pink-400 to-rose-400 hover:from-pink-500 hover:to-rose-500 rounded-full shadow-lg flex items-center gap-2" asChild>
                      <a href="https://www.facebook.com/profile.php?id=61578928634971" target="_blank" rel="noopener noreferrer">
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Card className="bg-gradient-to-br from-pink-50 to-rose-50 border-3 border-pink-200 rounded-3xl shadow-2xl">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-pink-600 font-serif">ready to order?</h2>
                </div>
                <p className="text-pink-700 mb-6 leading-relaxed">
                  dm us on instagram with your dream order! tell us about your celebration, how many cupcakes you need, and any special requests.
                </p>
                <Button 
            ...
            <Card className="bg-white/90 backdrop-blur-sm border-3 border-pink-200 rounded-3xl shadow-2xl">
              <CardContent className="p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-pink-600 font-serif">order details</h2>
                </div>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <Heart className="w-4 h-4 text-pink-400 fill-pink-400 mt-1 flex-shrink-0" />
                    <span className="text-pink-700">minimum order: 4 cupcakes</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <Heart className="w-4 h-4 text-pink-400 fill-pink-400 mt-1 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-3">
                    <Heart className="w-4 h-4 text-pink-400 fill-pink-400 mt-1 flex-shrink-0" />
                    <span className="text-pink-700">custom designs welcome for special occasions</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <Heart className="w-4 h-4 text-pink-400 fill-pink-400 mt-1 flex-shrink-0" />
                    <span className="text-pink-700">not recommended if you have allergies</span>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="bg-gradient-to-r from-pink-100 via-rose-100 to-pink-100 rounded-3xl p-12 border-3 border-pink-200 shadow-2xl text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h2 className="text-4xl font-bold text-pink-600 font-serif">we can't wait to hear from you</h2>
            <Heart className="w-8 h-8 text-pink-400 fill-pink-400 animate-pulse" />
          </div>
          <p className="text-xl text-pink-700 max-w-2xl mx-auto leading-relaxed mb-8">
            whether it's for a birthday party, wedding, baby shower, or just because you deserve something sweet, we're here to make it magical.
          </p>
          <div className="flex items-center justify-center gap-2">
            <Sparkles className="w-5 h-5 text-pink-400" />
            <span className="text-pink-600 font-medium italic">whisked with joy, baked with love</span>
            <Sparkles className="w-5 h-5 text-pink-400" />
          </div>
        </div>
      </div>
