        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-3 mb-8">
              ...
              <h3 className="text-4xl md:text-5xl font-bold text-pink-600 font-serif">
                about sugar blooms
              </h3>
              <Heart className="w-8 h-8 text-pink-400 fill-pink-400 animate-pulse" />
            </div>
              ...
              <div className="text-left space-y-6">
                <div className="bg-pink-50 rounded-2xl p-6 border-2 border-pink-200">
                  ...
                  <p className="text-lg text-pink-700 leading-relaxed">
                    ...
                    quickly became a passion for creating joy, one cupcake at a
                    time. every swirl of buttercream and delicate bow is placed
                ...
                <div className="bg-rose-50 rounded-2xl p-6 border-2 border-rose-200">
                  ...
                  <p className="text-lg text-rose-700 leading-relaxed">
                    to turn everyday moments into celebrations and make your day
                    a little brighter, a lot sweeter. every order is crafted
                    start to finish by one pair of hands.
                  </p>
                </div>
