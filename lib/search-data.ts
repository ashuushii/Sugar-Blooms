...
export const searchData: SearchResult[] = [
  // Products
  {
    ...
    description: "Light and fluffy vanilla cupcakes topped with smooth vanilla buttercream",
  ...
  },
  {
    ...
    description: "Rich chocolate cupcakes with chocolate ganache filling and chocolate buttercream",
  ...
  },
  {
    ...
    description: "Fresh strawberry cupcakes with strawberry buttercream and real fruit pieces",
  ...
  // Recipes
  {
    ...
    description: "Learn how to make smooth, creamy vanilla buttercream frosting",
  ...
  },
  {
    ...
    description: "Professional-grade silky smooth Swiss meringue buttercream recipe",
